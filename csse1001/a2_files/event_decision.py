"""
 _____                _    ______          _     _
|  ___|              | |   |  _  \        (_)   (_)
| |____   _____ _ __ | |_  | | | |___  ___ _ ___ _  ___  _ __
|  __\ \ / / _ \ '_ \| __| | | | / _ \/ __| / __| |/ _ \| '_ \
| |___\ V /  __/ | | | |_  | |/ /  __/ (__| \__ \ | (_) | | | |
\____/ \_/ \___|_| |_|\__| |___/ \___|\___|_|___/_|\___/|_| |_|
...
# Import your SimplePrediction and SophisticatedPrediction from prediction.py.
...
class EventDecision(object):
    ...
    def _temperature_factor(self):
        ...
        # Task 1 - adjust predicted temps based on humidity factor
        humidity_factor = 0
        ...
        # Task 2 - calculate initial temperature factor
        ...
        # Task 3 - adjust due to high temps
    ...
    def advisability(self):
        ...
        # Set the range for the advisability rank
...
class UserInteraction(object):
    ...
    def __init__(self):
        """
        Parameters:
              (None): Class is designed to create instance of another class, therefore does not have parameters
        """
        self._event = None
    ...
    def get_event_details(self):
        ...
        # create a local variable to hold event name
        ...
        while True:
            ...
            # make sure time entered is valid
