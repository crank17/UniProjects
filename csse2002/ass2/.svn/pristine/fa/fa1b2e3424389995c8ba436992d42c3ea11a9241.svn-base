...
public class Route {
    ...
    public boolean equals(Object obj){
        ...
        if (obj == null || this.getClass() != obj.getClass())
            return false;
        Route routeObject = (Route) obj; //explicitly cast obj to Route object

        return Objects.equals(id, routeObject.id)
                && defaultSpeed == routeObject.defaultSpeed
                && Objects.equals(trafficLight, routeObject.trafficLight)
                && Objects.equals(getTrafficLight(), routeObject.getTrafficLight())
                && Objects.equals(hasSpeedSign(), routeObject.hasSpeedSign())
                && Objects.equals(getSpeed(), routeObject.getSpeed())
                && sensors.equals(routeObject.sensors);
    ...
    public int hashCode(){
        return Objects.hash(id, defaultSpeed, trafficLight, speedSign, sensors);
